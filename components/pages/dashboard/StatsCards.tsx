...
export default function StatsCards() {
    return (
        <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[20px]'>
            <StatsCard title='Total Athletes' value='100' icon={<AthletesIcon />} />
            <StatsCard title='Total Challenges' value='147' icon={<ChallengesIcon />} />
            <StatsCard title='Total Sponsorships' value='20'     icon={<HandShakeIcon />} />
            <StatsCard title='Total Quotations' value='106' icon={<QuotationIcon />} />
        </section>
    )
}
